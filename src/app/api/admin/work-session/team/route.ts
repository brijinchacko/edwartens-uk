...
const ROLE_VISIBILITY: Record<string, string[]> = {
  SUPER_ADMIN: ["SUPER_ADMIN", "ADMIN", "SALES_LEAD", "ADMISSION_COUNSELLOR", "TRAINER", "HR_MANAGER"],
  ADMIN: ["ADMIN", "SALES_LEAD", "ADMISSION_COUNSELLOR", "TRAINER", "HR_MANAGER"],
  HR_MANAGER: ["SUPER_ADMIN", "ADMIN", "SALES_LEAD", "ADMISSION_COUNSELLOR", "TRAINER", "HR_MANAGER"],
  SALES_LEAD: [],
