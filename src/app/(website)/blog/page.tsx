              ...
              {filtered.map((post, idx) => (
                ...
                >
                  ...
                  <div className="p-6 flex flex-col flex-1">
                    ...
                    {/* Author + Date */}
                    <div className="flex items-center justify-between text-xs text-text-muted mb-3 border-t border-white/[0.04] pt-3">
                      <span>{post.author}</span>
                      <span>{new Intl.DateTimeFormat("en-GB", { day: "numeric", month: "short", year: "numeric" }).format(new Date(post.publishedAt))}</span>
                    </div>
