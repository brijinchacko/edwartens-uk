  ...
  async function handleSubmit(e: FormEvent) {
    ...
    try {
      const res = await fetch("/api/certificates/verify", {
        ...
        body: JSON.stringify({ certificateNo, name, dateOfBirth }),
      });
      ...
      <section className="mesh-gradient-hero py-24 sm:py-32 relative">
        ...
        <div className="max-w-7xl mx-auto px-3 sm:px-5 lg:px-6 relative z-10 text-center">
          ...
          <p className="text-lg text-text-secondary max-w-2xl mx-auto leading-relaxed">
            Enter the certificate details below to verify its authenticity. This
            system validates all certificates issued by EDWartens UK.
          </p>
        </div>
      </section>
              ...
              <div className="mt-6 p-4 rounded-lg bg-red-500/10 border border-red-500/20 flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-red-300/70 mt-1">
                    {result.message ||
                      "The details provided do not match any certificate in our records. Please check the information and try again."}
                  </p>
                </div>
              </div>
            )}
