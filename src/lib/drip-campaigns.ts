...
const TRIGGER_STATUS_MAP: Record<string, string[]> = {
  NEW_LEAD: ["NEW", "CONTACTED", "FIRST_CALL", "CONSULTATION_ARRANGED", "CONSULTATION_COMPLETED", "QUALIFIED", "REGISTERED", "ENROLLED"],
  CONTACTED: ["CONTACTED", "FIRST_CALL", "CONSULTATION_ARRANGED", "CONSULTATION_COMPLETED", "QUALIFIED", "REGISTERED", "ENROLLED"],
  FIRST_CALL: ["FIRST_CALL", "CONSULTATION_ARRANGED", "CONSULTATION_COMPLETED", "QUALIFIED", "REGISTERED", "ENROLLED"],
  CONSULTATION_ARRANGED: ["CONSULTATION_ARRANGED", "CONSULTATION_COMPLETED", "QUALIFIED", "REGISTERED", "ENROLLED"],
  CONSULTATION_COMPLETED: ["CONSULTATION_COMPLETED", "QUALIFIED", "REGISTERED", "ENROLLED"],
  QUALIFIED: ["QUALIFIED", "REGISTERED", "ENROLLED"],
  REGISTERED: ["REGISTERED", "ENROLLED"],
  POST_CONSULTATION: ["CONSULTATION_COMPLETED", "QUALIFIED", "REGISTERED", "ENROLLED"],
  ENROLLED: ["ENROLLED"],
};
