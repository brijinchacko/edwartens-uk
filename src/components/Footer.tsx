...
const socialLinks = [
  {
    name: "LinkedIn",
    href: "https://linkedin.com/company/108279734",
    icon: (
  ...
  {
    name: "YouTube",
    href: "https://youtube.com/channel/UC50h3bbLfdXOz9AxjHtzgdQ",
    icon: (
      <svg viewBox="0 0 24 24" fill="currentColor" className="w-4 h-4">
  ...
  {
    name: "Instagram",
    href: "https://instagram.com/edwartensuk",
    icon: (
      <svg viewBox="0 0 24 24" fill="currentColor" className="w-4 h-4">
  ...
  {
    name: "Facebook",
    href: "https://facebook.com/wartensuk",
    icon: (
      <svg viewBox="0 0 24 24" fill="currentColor" className="w-4 h-4">
